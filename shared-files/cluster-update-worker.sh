...
do
    ...
    lxc file push /home/$operator/ansible-testbed/shared-files/p                       cd-db-0$i/home/$operator/.cb/p
    echo "--------pushing worker-init-user.sh from $clusterMember to cd-db-0$i"
    lxc file push /home/$operator/ansible-testbed/shared-files/worker-init-user.sh     cd-db-0$i/home/$operator/.cb/worker-init-user.sh
